const PROFILE_KEY = "squatTribe_v28_profile";
const HISTORY_KEY = "squatTribe_v28_history";
const ROTATION_KEY = "squatTribe_v28_rotation";
...
function renderPreviousExerciseSummary(exercise) {
  ...
  if (exercise.type === "bilateral") {
    ...
    target.innerHTML =
      `Left Anchor: ${last.left?.anchorReps ?? "-"} | Myo: ${leftSets}<br>Right Anchor: ${last.right?.anchorReps ?? "-"} | Myo: ${rightSets}<br>Total TRDS: ${last.TRDS}`;
  }
}
